...
public abstract partial class BaseFhirClient : IDisposable
{
        ...
        IStructureDefinitionSummaryProvider? provider = null)
    {
        ...
        Endpoint = baseUrlProvider.GetBaseUrl();
    ...
    {
        return RefreshAsync(current).WaitResult();
    }
    ...
    private async Task<TResource> executeAsync<TResource>(Bundle tx, IEnumerable<HttpStatusCode> expect) where TResource : Resource
    {
        ...
        catch (UnsupportedBodyTypeException ex)
        {
            ...
            throw BuildFhirOperationException(code, operationOutcome); // this was an internal method, in FhirOperationException
        }
        ...
        try
        {
            ...
            {
                Enum.TryParse(typedEntryResponse.Status, out HttpStatusCode code);
                throw BuildFhirOperationException(code, response.Resource, typedEntryResponse.GetBodyAsText());
            }
    ...
    private void verifyServerVersion()
    {
        ...
        try
        {
            ...
            Settings.ParserSettings = new Hl7.Fhir.Serialization.ParserSettings() { AllowUnrecognizedEnums = true };
    ...
    //
    // TODO: // this was an internal method, in FhirOperationException
    //
