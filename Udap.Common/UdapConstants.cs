...
namespace Udap.Common
{
    ...
    public static class UdapConstants
    {
        ...
        public static class RegistrationDocumentValues
        {
            ...
            public const string Expiration = JwtClaimTypes.Expiration;
            public const string IssuedAt = JwtClaimTypes.IssuedAt;
            public const string JwtId = JwtClaimTypes.JwtId;
