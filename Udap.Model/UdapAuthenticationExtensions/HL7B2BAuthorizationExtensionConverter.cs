...
public class HL7B2BAuthorizationExtensionConverter : JsonConverter<HL7B2BAuthorizationExtension>
{
    public override HL7B2BAuthorizationExtension Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        var dictionary = JsonSerializer.Deserialize<Dictionary<string, object>>(ref reader, options);
        var extension = new HL7B2BAuthorizationExtension();
        foreach (var kvp in dictionary)
        {
            if (kvp.Value is JsonElement jsonElement && jsonElement.ValueKind == JsonValueKind.Array)
            {
                ...
                var properties = typeof(HL7B2BAuthorizationExtension).GetProperties(BindingFlags.Public | BindingFlags.Instance);
    ...
    public override void Write(Utf8JsonWriter writer, HL7B2BAuthorizationExtension value, JsonSerializerOptions options)
    {
