...
///
/// Modeled after Duende AuthenticationManagerExtensions
/// </summary>
public static class AuthenticationManagerExtensions
{
    ...
    /// <returns></returns>
    public static async Task SignInAsync(this HttpContext context, TieredOAuthUser user)
    {
    ...
    /// <returns></returns>
    public static async Task SignInAsync(this HttpContext context, TieredOAuthUser user, AuthenticationProperties properties)
    {
