...
namespace UdapServer.Tests
{
    public class ApiTestFixture : WebApplicationFactory<Program>
    {
        ...
        public ApiTestFixture()
        {
            ...
            Config = new ConfigurationBuilder()
                ...
                .AddUserSecrets(typeof(IdServerRegistrationTests).Assembly)
                .Build();
        }
    ...
    /// <summary>
    /// Full Web tests.  Using <see cref="IdentityProvider"/> web server.
    /// </summary>
    public class IdServerRegistrationTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async Task RegisrationSuccess_FhirLabs_Test()
        {
            ...
            var manifest = _fixture.Config.GetSection("UdapFileCertStoreManifest").Get<UdapFileCertStoreManifest>();
