...
else if (connStrName.Equals("gcp_alloydb", StringComparison.OrdinalIgnoreCase))
{
...
else if (connStrName.Equals("gcp_alloydb_Idp1", StringComparison.OrdinalIgnoreCase))
{
...
else if (connStrName.Equals("gcp_alloydb_Idp2", StringComparison.OrdinalIgnoreCase))
{
